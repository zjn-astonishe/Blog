...
## 3.5. i2c_adapter添加函数i2c_add_adapter()
...
### 3.5.2. 已指定ID号i2c_adapter注册函数__i2c_add_numbered_adapter()
...
### 3.5.3. i2c_adapter注册函数i2c_register_adapter()
...
### 3.5.4. 解析从设备，构建i2c_client函数of_i2c_register_devices()
